...
public class Test implements Serializable {
	...
	private ArrayList<A_Question> testQuestions;
	...
	public Test(int num) {
		testQuestions = new ArrayList<A_Question>();
		numOfQuestions = 0;
	...
	public void swap(int i, int j) throws IndexOutOfBoundsException {
		A_Question tmp = testQuestions.get(i);
	...
	public void setQuestions(List<A_Question> list) {
		...
		testQuestions.addAll(list);
		numOfQuestions = testQuestions.size();
	}
